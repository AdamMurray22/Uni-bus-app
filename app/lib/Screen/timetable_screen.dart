  ...
  void initState() {
    MapDataLoader.getDataLoader().onDataLoaded((mapData) {
      setState(() {
        ...
        {
          List<DropdownMenuItem<String>> times1 = item1.items as List<DropdownMenuItem<String>>;
          ...
          List<DropdownMenuItem<String>> times2 = item2.items as List<DropdownMenuItem<String>>;

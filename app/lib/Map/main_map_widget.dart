...
class MainMapWidgetState extends MapWidgetState<MainMapWidget> {
  ...
  createLayers() {
    ...
    createMakerLayer(MapDataId.u1.idPrefix, "U1BusStopMarker.png", 0.25, 0.5, 1, true);
    createMakerLayer(MapDataId.uniBuilding.idPrefix, "UniBuildingMarker.png", 0.25, 0.5, 1, true);
    createMakerLayer(MapDataId.landmark.idPrefix, "LandmarkMarker.png", 0.25, 0.5, 1, true);

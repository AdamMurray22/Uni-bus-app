...
void main() {
  group('Walking Route Tests', () {
    ...
    test('.getNextTurn() valid string with ""', () {
      WalkingRoute route = WalkingRoute(["_geometry"], 0, 0, 0, '"Turn"');
